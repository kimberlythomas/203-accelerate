			...
			switch ( $button_name ) {
				...
				case 'twitter':
					...
					if ( $theme == 'simple-icons' ) {
						...
						$_html = '<button class="ssb_tweet-icon" ' . $ssb_attr_html . ' data-href="https://twitter.com/share?text=' . $title . '&url=' . $permalink . '' . $via . '" onclick="javascript:window.open(this.dataset.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\');return false;">
						...
						$_html = '<button class="simplesocial-twt-share" ' . $ssb_attr_html . ' data-href="https://twitter.com/share?text=' . $title . '&url=' . $permalink . '' . $via . '" onclick="javascript:window.open(this.dataset.href, \'\', \'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600\');return false;"><span class="simplesocialtxt">Twitter</span> ';
